...
unsigned int generateTexture(char const *path) {
...
int main() {
    ...
    unsigned int texture = generateTexture("/home/chris/CLionProjects/Chess/assets/wk.png");
    glEnable(GL_BLEND);
...
// Class
// Draw(int index, Color color, Texture texture) ->